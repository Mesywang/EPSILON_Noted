...
public:
    ...
    virtual ErrorType GetForwardTrajectories(std::vector<LateralBehavior>* behaviors,
    ...
    virtual ErrorType GetObstacleGrids(std::set<std::array<decimal_t, 2>>* obs_grids) = 0;
};
