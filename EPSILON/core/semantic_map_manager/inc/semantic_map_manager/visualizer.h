...
public:
    ...
    void VisualizeDataWithStampForPlayback(const ros::Time& stamp, const SemanticMapManager& smm,
...
private:
    ...
    void VisualizeSurroundingLaneNet(const ros::Time& stamp, const common::LaneNet& lane_net,
                                     const std::vector<int>& deleted_lane_ids);
    void VisualizeBehavior(const ros::Time& stamp, const common::SemanticBehavior& behavior);
    void VisualizeSurroundingVehicles(const ros::Time& stamp, const common::VehicleSet& vehicle_set,
                                      const std::vector<int>& nearby_ids);
    void VisualizeLocalLanes(const ros::Time& stamp, const std::unordered_map<int, common::Lane>& local_lanes,
    ...
    void VisualizeOpenloopTrajPrediction(const ros::Time& stamp,
