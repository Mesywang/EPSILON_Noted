...
public:
   ...
   */
    ErrorType Connect(const FrenetState& fs0, const FrenetState& fs1, const decimal_t stamp, const decimal_t T,
   ...
   */
    ...
    Polynomial<5> poly_s() const {
        return poly_s_;
    }
    Polynomial<5> poly_d() const {
        return poly_d_;
    }

    void set_poly_s(const Polynomial<5>& poly) {
        poly_s_ = poly;
    }
    void set_poly_d(const Polynomial<5>& poly) {
        poly_d_ = poly;
    }
    /**
   * @brief Debug print
