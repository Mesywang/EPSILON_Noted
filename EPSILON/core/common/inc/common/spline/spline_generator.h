...
public:
    ...
    static ErrorType GetCubicSplineBySampleInterpolation(const vec_Vecf<N_DIM>& samples,
                                                         const std::vector<decimal_t>& para, SplineType* spline);
     ...
     */
    static ErrorType GetQuinticSplineBySampleFitting(const vec_Vecf<N_DIM>& samples, const std::vector<decimal_t>& para,
     ...
     */
    static ErrorType GetSplineFromStateVec(const std::vector<decimal_t>& para, const vec_E<State>& state_vec,
                                           SplineType* spline);
     ...
     * @param spline, spline returned
     */
    static ErrorType GetSplineFromFreeStateVec(const std::vector<decimal_t>& para,
    ...
    static ErrorType GetBezierSplineUsingCorridor(const vec_E<SpatioTemporalSemanticCubeNd<N_DIM>>& cubes,
                                                  ...
                                                  const vec_E<Vecf<N_DIM>>& ref_points,
