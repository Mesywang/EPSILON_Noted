...
public:
     ...
     */
    ErrorType GetCurvatureByArcLength(const decimal_t& arc_length, decimal_t* curvature,
    ...
    ErrorType GetArcLengthByVecPositionWithInitialGuess(const Vecf<LaneDim>& vec_position,
    ...
    SplineType position_spline() const {
        return position_spline_;
    }

    decimal_t begin() const {
        return position_spline_.begin();
    }

    decimal_t end() const {
        return position_spline_.end();
    }

    void print() const {
        position_spline_.print();
    }
