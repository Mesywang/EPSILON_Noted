...
OrientedBoundingBox2D::OrientedBoundingBox2D(const decimal_t x_, const decimal_t y_, const decimal_t angle_,
                                             const decimal_t width_, const decimal_t length_)
    : x(x_),
      y(y_),
      angle(angle_),
      width(width_),
...
ErrorType ShapeUtils::GetPerpendicularAxisOfOrientedBoundingBox(const vec_E<Vecf<2>>& vertices, const int index,
                                                                Vecf<2>* axis) {
